// src/app/pages/admin/pages/manage-exams/add-questions/components/writing-questions/writing-questions.component.ts
...
export class WritingQuestionsComponent implements OnInit {
  ...
  // ============================================================
  // STATE - CỐ ĐỊNH 2 CÂU HỎI (TASK 1 & TASK 2)
  // ============================================================
  ...
  // ============================================================
  // GET QUESTIONS DATA (CHO ADD-QUESTIONS COMPONENT)
  // ============================================================

  getQuestionsData(): WritingQuestion[] {
    const result: WritingQuestion[] = [];
    
    // Thêm Task 1 nếu có dữ liệu
    if (this.task1.promptText.trim()) {
      result.push({ ...this.task1 });
    }
    
    // Thêm Task 2 nếu có dữ liệu
    if (this.task2.promptText.trim()) {
  ...
  // ============================================================
  // RESET (CHO ADD-QUESTIONS COMPONENT)
  // ============================================================
